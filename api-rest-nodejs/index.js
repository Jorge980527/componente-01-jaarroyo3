...
app.post("/libros",(req,res)=>{
    ...
    const query = "INSERT INTO libro(Título, Autor, Editorial, Nro-páginas, Stock, Estado) VALUES(?,?,?,?,?,?)";
...
app.put("/libros/:id", (req, res) => {
    const { id } = req.params;
    const { titulo, autor, editorial, nropaginas, stock, estado } = req.body;
    const query = "UPDATE libro SET titulo = ?, Autor = ?, Editorial = ?, Nro páginas = ?, Stock = ?, Estado = ? WHERE id = ?";
